      ...
      <Card>
        <CardContent className="p-4 space-y-4 text-sm leading-relaxed text-foreground/90">
          ...
          <section className="space-y-2">
            ...
            <p>
              Приложение предлагает дополнительный функционал за плату через сервис ЮMoney.
              Обработка платежей осуществляется на стороне ЮMoney в соответствии с их
              политикой конфиденциальности и условиями обслуживания.
            </p>
            <p>
              Приложение не хранит и не обрабатывает данные банковских карт или платёжных
              систем.
            </p>
          </section>
