      ...
      <Card>
        <CardContent className="p-4 space-y-4 text-sm leading-relaxed text-foreground/90">
          ...
          <section className="space-y-2">
            ...
            <p>
              При использовании локальных моделей данные <strong>не покидают устройство пользователя</strong> и не передаются по сети. 
              Это обеспечивает максимальный уровень конфиденциальности.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              оплаты. Серверные модели предоставляются без ограничений в рамках общей квоты.
            </p>
            <p>
              ...
              и обрабатывать данные банковских карт или платёжных систем.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              обращайтесь через email: nikita_avdonin@mail.ru или на GitHub-странице проекта: <a href='https://github.com/NikasAl/NutriAdvisor'>NutriAdvisor</a>
            </p>
          </section>
        </CardContent>
      </Card>
